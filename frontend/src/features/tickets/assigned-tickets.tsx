    ...
    return (
        <AppShell>
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">My Assigned Tickets</h1>
                    <p className="text-muted-foreground text-sm">Tickets assigned to you for resolution</p>
                </div>
                <Button asChild>
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={5} className="text-center py-4">No assigned tickets found</TableCell>
                            </TableRow>
                        ) : (
