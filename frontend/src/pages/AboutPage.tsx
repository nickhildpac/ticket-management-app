          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="w-24 h-24 bg-gray-300 rounded-full mx-auto mb-3 flex items-center justify-center">
                <span className="text-gray-600 text-2xl">JP</span>
              </div>
            ...
            <div>
              <div className="w-24 h-24 bg-gray-300 rounded-full mx-auto mb-3 flex items-center justify-center">
                <span className="text-gray-600 text-2xl">SM</span>
              </div>
            ...
            <div>
              <div className="w-24 h-24 bg-gray-300 rounded-full mx-auto mb-3 flex items-center justify-center">
                <span className="text-gray-600 text-2xl">RJ</span>
              </div>
              <h3 className="font-medium">Robert Johnson</h3>
              <p className="text-gray-600 text-sm">Support Manager</p>
            </div>
          </div>
        </div>
      </div>
